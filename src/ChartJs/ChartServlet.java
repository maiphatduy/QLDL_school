 ...
 */
@WebServlet(urlPatterns = {"/ChartJs", "/chartjs", "/bieudo"})
public class ChartServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
        	request.setAttribute("DataLow",ChartJs.GetScore_below_average());
        	request.setAttribute("DataMin",ChartJs.GetMin_score());
        	request.setAttribute("DataMax",ChartJs.GetMax_score());
            request.setAttribute("DataClass",ChartJs.GetClass());
            request.setAttribute("web_title","ChartJs");
            request.setAttribute("web_content","index.jsp");
