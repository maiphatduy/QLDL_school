...
public class editClassRServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("Data",ClassR.Details(id));
            request.setAttribute("web_title","Edit Class");
            request.setAttribute("web_content","ClassR/editClassR.jsp");
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            session.setAttribute("SUCCESS_MSG", "Edit Successful");
