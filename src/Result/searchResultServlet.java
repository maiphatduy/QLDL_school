...
@WebServlet(urlPatterns = {"/SearchResult", "/searchresult", "/timkiemketqua"})
public class searchResultServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
        	...
        	String keywork = request.getParameter("SearchResult");
            request.setAttribute("DataTable",Result.Search(keywork));
