		...
		<div class="page-utilities">
			<div
				...
				<div id="demo" class="col-auto collapse">
					<form>
						<input type="text" name="Min" value="" placeholder="from"/> 
						<input type="number"
							Name="Max" value="" placeholder="to" /> <input type="submit" value="filter">
					</form>
				</div>
					...
					<table id="datatablesSimple"
						...
						<thead>
							<tr>
								...
								<th class="cell">Name Subject</th>
								<th class="cell">Point 					<a href="#demo" class="fa-solid fa-filter" data-bs-toggle="collapse"></a></th>
