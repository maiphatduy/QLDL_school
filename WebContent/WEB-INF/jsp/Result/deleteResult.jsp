	...
	<form method="post" action="/deleteResult?ResultId=${Data.ResultId}"
		...
		<div class="mb-3">
			<label for="Point" class=" form-label">Point:</label> <input
				...
				placeholder="Point" value="${Data.Point}" required readonly>
			<div class="valid-feedback">Looks good!</div>
		</div>
		<div class="mb-3">
			<label for="StudentId" class=" form-label">StudentId:</label> <input
				type="text" class="form-control" name="StudentId" id="StudentId"
				placeholder="StudentId" value="${Data.StudentId}" required readonly>
			<div class="valid-feedback">Looks good!</div>
		</div>
		<div class="mb-3">
			<label for="SubjectId" class=" form-label">SubjectId:</label> <input
				type="text" class="form-control" name="SubjectId" id="SubjectId"
				placeholder="SubjectId" value="${Data.SubjectId}" required readonly>
			<div class="valid-feedback">Looks good!</div>
		</div>
		<br class="clear_float"> <label
			style="width: 100%; text-align: left;">Are you sure want to
			delete?</label>
